document.addEventListener("DOMContentLoaded", () => {
  ...
  ).getPropertyValue("--button-hover-color");

  // ====== BUTTONS HOVER ======
  const buttons = document.querySelectorAll(
    ".hero-section .links a, .contact-section button"
  );
  ...
  const faders = document.querySelectorAll(
    ".fade-in, .project, .skills-section .cell, p, .hero-section .links a, .contact-section button"
  );
